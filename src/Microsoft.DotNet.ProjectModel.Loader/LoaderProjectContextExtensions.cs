            ...
            string outputPath)
        {
            ...
            foreach (var export in exporter.GetAllExports())
            {
                ...
                var group = string.IsNullOrEmpty(runtimeIdentifier) ?
                    ...
                    GetGroup(export.RuntimeAssemblyGroups, runtimeIdentifier, rids.FirstOrDefault(r => r.Runtime.Equals(runtimeIdentifier)));
                if(group != null)
                {
                ...
                group = string.IsNullOrEmpty(runtimeIdentifier) ?
                    ...
                    GetGroup(export.NativeLibraryGroups, runtimeIdentifier, rids.FirstOrDefault(r => r.Runtime.Equals(runtimeIdentifier)));
                if(group != null)
                {
                    foreach(var asset in group.Assets)
                    {
